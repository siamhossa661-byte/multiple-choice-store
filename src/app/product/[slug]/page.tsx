    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
        ...
        <div className="lg:sticky lg:top-28 lg:self-start space-y-6">
          {product.newArrival && (
            <span className="inline-block px-3 py-1 bg-black text-cream text-[10px] tracking-widest uppercase font-medium">
              New Arrival
            </span>
          )}
          ...
          <div className="flex items-center gap-3">
            <span
              className={`text-xl font-medium ${
                compareAt && compareAt > price ? "text-red-700" : "text-neutral-900"
              }`}
            >
          ...
          <div className="border-t border-neutral-200 pt-6 space-y-4">
            {product.material && (
              <div className="flex items-start gap-4">
                <span className="text-xs tracking-widest uppercase text-neutral-500 w-24 flex-shrink-0 pt-0.5">
                  Material
                </span>
                <span className="text-sm text-neutral-700">{product.material}</span>
              </div>
            )}
            <div className="flex items-start gap-4">
              <span className="text-xs tracking-widest uppercase text-neutral-500 w-24 flex-shrink-0 pt-0.5">
      ...
      {/* Reviews */}
      <section className="mt-20 lg:mt-28 border-t border-neutral-200 pt-12">
          ...
          {productReviews.length === 0 ? (
            ...
            <div className="space-y-8">
              {productReviews.map((review) => (
                <div
                  key={review.id}
                  className="border-b border-neutral-200/60 pb-8 last:border-0"
                >
